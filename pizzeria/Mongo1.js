...
var server=express();
var cors=require("cors"); //Cross-Origin Resource Sharing (CORS) is an HTTP-header based mechanism that allows a server to indicate any origins (domain, scheme, or port) other than its own from which a browser should permit loading resources.
...
var connect = mongoclient.connect(url, (err,connectResult) => {
    ...
    if (err) {
        ...
        var database=connectResult.db("training")
        database.collection("Ingredients").insertOne(emp)
